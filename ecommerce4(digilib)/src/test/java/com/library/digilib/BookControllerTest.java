...
public class BookControllerTest {
    ...
    // inject TestRestTemplate to make REST calls.
    @Autowired
    ...
    // Write a unit test for the GET /books/{id} method.
    @Test
    ...
    // Write a unit test for the POST /books/{id}/borrow method.
    ...
    // Write a unit test for the POST /books/{id}/return method.
    @Test
