...
async function registerUser(event) {
    ...
    try {
        // TODO 3: If passwords match, create a POST request to REGISTER_API_URL to send the user data { username, password, role: "USER" } to the server. Handle the response to check if registration is successful or if it fails.
